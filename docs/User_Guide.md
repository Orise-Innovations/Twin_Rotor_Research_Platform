...
<!-- vscode-markdown-toc -->
* [Connecting to the Twin Rotor](#ConnectingtotheTwinRotor)
	* [Connecting the Twin Rotor to the Network](#ConnectingtheTwinRotortotheNetwork)
	* [User Credentials](#UserCredentials)
	* [Connecting Via SSH](#ConnectingViaSSH)
* [Running Examples](#RunningExamples)
* [Shutting Down](#ShuttingDown)
* [Controlling Motors](#ControllingMotors)
	* [Set speed of both motors](#Setspeedofbothmotors)
	* [Set speed of motor0](#Setspeedofmotor0)
	* [Set speed of motor1](#Setspeedofmotor1)
	* [Stop motors](#Stopmotors)
	* [Stop motor 0](#Stopmotor0)
	* [Stop motor 1](#Stopmotor1)
* [Getting Sensor Data](#GettingSensorData)
* [Using the CSV Logger](#UsingtheCSVLogger)
* [Using the Simple Logger](#UsingtheSimpleLogger)
* [Basic Usage - Plotting Raw Sensor Data](#BasicUsage-PlottingRawSensorData)
* [Importing the Libraries](#ImportingtheLibraries)
* [Creating the GUI](#CreatingtheGUI)
* [Adding the plots](#Addingtheplots)
	* [title](#title)
	* [reading_name](#reading_name)
	* [color (Optional)](#colorOptional)
	* [name (Optional)](#nameOptional)
* [Running the GUI.](#RunningtheGUI.)
* [Updating buffers and While Loop](#UpdatingbuffersandWhileLoop)
	* [Plotting Custom Data using Custom Buffers **add_custom_buffer_graph**](#PlottingCustomDatausingCustomBuffersadd_custom_buffer_graph)
	* [Plotting by providing a function to calculate data from raw readings.](#Plottingbyprovidingafunctiontocalculatedatafromrawreadings.)
* [Checking if the Gui is Active](#CheckingiftheGuiisActive)
* [Things to watch out for.](#Thingstowatchoutfor.)
* [Trouble Shooting](#TroubleShooting)
	* [The Gui is not starting up](#TheGuiisnotstartingup)
	* [The Gui starts up but no plots (or just some plots) are plotted](#TheGuistartsupbutnoplotsorjustsomeplotsareplotted)
	* [The plots show up but the graphs don't show or anything (or they are static)](#Theplotsshowupbutthegraphsdontshoworanythingortheyarestatic)
...
## <a name='ConnectingtotheTwinRotor'></a>Connecting to the Twin Rotor
The main way you can connect to the twin rotor is via connecting to it via [SSH](https://en.wikipedia.org/wiki/Secure_Shell).
### <a name='ConnectingtheTwinRotortotheNetwork'></a>Connecting the Twin Rotor to the Network

### <a name='UserCredentials'></a>User Credentials
| | |
|---|---|
|Hostname|OriseTRS|
|Username|pi|
|default password|raspberry|
### <a name='ConnectingViaSSH'></a>Connecting Via SSH
...
## <a name='RunningExamples'></a>Running Examples
...
## <a name='ShuttingDown'></a>Shutting Down 
...
## <a name='ControllingMotors'></a>Controlling Motors
...
### <a name='Setspeedofbothmotors'></a>Set speed of both motors
```python
twin_rotor.motors.set_speed(m0_speed_rpm,m1_speed_rpm)
```

the provided speeds must be in rpm
### <a name='Setspeedofmotor0'></a>Set speed of motor0
```python
twin_rotor.motors.set_speed_M0(speed_rpm)
```

### <a name='Setspeedofmotor1'></a>Set speed of motor1
```python
twin_rotor.motors.set_speed_M1(speed_rpm)
```

### <a name='Stopmotors'></a>Stop motors
```python
twin_rotor.motors.stop()
```

### <a name='Stopmotor0'></a>Stop motor 0
```python
twin_rotor.motors.stopM0()
```

### <a name='Stopmotor1'></a>Stop motor 1
```python
twin_rotor.motors.stopM1()
```
## <a name='GettingSensorData'></a>Getting Sensor Data
...
## <a name='UsingtheCSVLogger'></a>Using the CSV Logger
...
## <a name='UsingtheSimpleLogger'></a>Using the Simple Logger
```python
...
## <a name='BasicUsage-PlottingRawSensorData'></a>Basic Usage - Plotting Raw Sensor Data
...
## <a name='ImportingtheLibraries'></a>Importing the Libraries
```python
...
## <a name='CreatingtheGUI'></a>Creating the GUI
...
## <a name='Addingtheplots'></a>Adding the plots
...
### <a name='reading_name'></a>reading_name
...
### <a name='colorOptional'></a>color (Optional)
...
### <a name='nameOptional'></a>name (Optional)
...
## <a name='RunningtheGUI.'></a>Running the GUI.
...
## <a name='UpdatingbuffersandWhileLoop'></a>Updating buffers and While Loop
...
### <a name='PlottingCustomDatausingCustomBuffersadd_custom_buffer_graph'></a>Plotting Custom Data using Custom Buffers **add_custom_buffer_graph**
...
### <a name='Plottingbyprovidingafunctiontocalculatedatafromrawreadings.'></a>Plotting by providing a function to calculate data from raw readings.
...
## <a name='CheckingiftheGuiisActive'></a>Checking if the Gui is Active
...
## <a name='Thingstowatchoutfor.'></a>Things to watch out for.
...
### <a name='TheGuiisnotstartingup'></a>The Gui is not starting up
...
### <a name='TheGuistartsupbutnoplotsorjustsomeplotsareplotted'></a>The Gui starts up but no plots (or just some plots) are plotted
- Make sure you are adding the plots **before** calling **.start()**

### <a name='Theplotsshowupbutthegraphsdontshoworanythingortheyarestatic'></a>The plots show up but the graphs don't show or anything (or they are static)
